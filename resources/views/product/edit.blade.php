...
@section('content')
    ...
    <form action="{{ route('product.store') }}" method="post">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-5">
                <input value="{{ $edit->product_name }}" type="text" class="form-control" id="" name="product_name" placeholder="product_name">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-5">
                <input value="{{ $edit->product_qty }}" type="number" class="form-control" id="" name="product_qty" placeholder="product_qty">
                </input>
            </div>
        </div>
        <div class="mb-3 row">
